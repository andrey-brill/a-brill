...
const GlassesSvg = React.forwardRef((_props, ref) => (
    <svg ref={ref} xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 2380 800.109">
...
export class Glasses extends React.Component {
    ...
    componentDidMount () {
        ...
        function onLoad () {
            ...
            const pathData = req.responseText;
        ...
        req.open("GET", "/assets/glasses-path.str");
        req.send();
    }
